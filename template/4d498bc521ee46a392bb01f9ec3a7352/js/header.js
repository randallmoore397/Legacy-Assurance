...
function VariableInit() {
    ...
    vertLIClMmenu = document.querySelectorAll('[data-theme-vertLICl-menu="zptheme-vertLICl-menu"]')[0];
...
function responsivechanges() {
    ...
    if (document.documentElement.clientWidth > 992) {
        ...
        if ((topBar && headerSearchCart && headerSearchCartPositionResponsive && (headerSearchCart.parentElement !== headerSearchCartPositionResponsive)) || (headerSearchCart && vertLIClMmenu && headerSearchCartPositionResponsive && (headerSearchCart.parentElement !== headerSearchCartPositionResponsive)) || (hasHeaderSeven && headerSearchCart && headerSearchCartPositionResponsive && (headerSearchCart.parentElement !== headerSearchCartPositionResponsive))) {
        ...
        if (headerSearchCartPositionResponsive && headerSearchCartPositionNonResponsive && topBar || headerSearchCartPositionNonResponsive && vertLIClMmenu) {
